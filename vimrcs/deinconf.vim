if dein#load_state(expand('~/vimrt/plugins'))
  ...
  call dein#add('Shougo/vimproc.vim', {'build' : 'mingw32-make -f make_mingw64.mak'})
  ...
  call dein#add('Valloric/YouCompleteMe',{'build' : 'python install.py --clang-completer --omnisharp-copleter', 'merged' : 0})
  call dein#end()
